...
namespace Infrastructure.Persistence
{
    public static class ApplicationDbContextSeed
    {
        public static void Seed(ApplicationDbContext context)
        {
            ...
            // Notifications
            var n1 = new Notification { Message = "Notifikacija 1", UserId = 19, RequestId = 1 };
            var n2 = new Notification { Message = "Notifikacija 2", UserId = 19, RequestId = 1 };
            var n3 = new Notification { Message = "Notifikacija 3", UserId = 19, RequestId = 1 };
            var n4 = new Notification { Message = "Notifikacija 4", UserId = 19, RequestId = 1 };
            var n5 = new Notification { Message = "Notifikacija 5", UserId = 19, RequestId = 1 };
            var n6 = new Notification { Message = "Notifikacija 6", UserId = 19, RequestId = 1 };
            var n7 = new Notification { Message = "Notifikacija 7", UserId = 19, RequestId = 1 };
            var n8 = new Notification { Message = "Notifikacija 8", UserId = 19, RequestId = 1 };
            var n9 = new Notification { Message = "Notifikacija 9", UserId = 19, RequestId = 1 };
            var n10 = new Notification { Message = "Notifikacija 10", UserId = 19, RequestId = 1 };
